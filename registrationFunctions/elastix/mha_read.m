...
% Hard-coded to expect a 16 bit double, since that's what mha_write produces
%
% Original on FEX:
% Viewer3D by Dirk-Jan Kroon (file: mha_read_volume.m)
...
%<raac>
V = single(V);
V = V/2^16; %Hack to get it back to 0 to 1 (ROB)
%</raac>
