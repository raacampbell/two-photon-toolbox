function shifted=alignCentroidsQuaternion(A,B,doPlot)
% Align centroids in B with those in A. Returns matrix B such that
% it is aligned with A. 
%
% function shifted=alignCentroidsQuaternion(A,B,doPlot)
%
% Uses a linear, quaternion based, method for aligning
% centroids. This allows for 10 degrees of freedom: translation
% (3), rotation (9), and scale (1). The two point sets must have
